package org.troyargonauts.common.math;
...
import org.troyargonauts.common.util.HashBuilder;
...
public final class Vector2D {
    ...
    /**
     * @see org.troyargonauts.common.util.HashBuilder#combineHash(int, int)
    ...
    public String toString() {
        ...
        out.append("Vector2D(");
        out.append(OMath.round(x, STRING_SIGFIGS));
        out.append(", ");
        out.append(OMath.round(y, STRING_SIGFIGS));
        out.append(")");
        return out.toString();
    }
}
